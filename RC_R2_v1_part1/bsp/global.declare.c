...
ST_MOTOR leftup_turn_motor = {.motor_id = 1, .motor_type = M2006,.uiGearRatio = M2006_uiGearRatio, .ControlLoop_State = SPEED_LOOP, .Input = 0.0f, .motor_encoder = {.siNumber = 8192, .siSumValue = 0, .siRawValue = 0, .state = 0}, 
    .pid_inner = {.fpKp = 180.f, .fpKi = 0.005f, .fpKd = 0.002f, .fpUMax = 9000.f, .fpUpMax = 9000.f, .fpUdMax = 5000.f, .fpSumEMax = 5000.f, .fpEMax = 500.f, .fpEMin = 1.0f},
    .pid_outer = {.fpKp = 5.f, .fpKi = 0.02f, .fpKd = 1.5f, .fpUMax = 400.f, .fpUpMax = 400.f, .fpUdMax = 80.f, .fpSumEMax = 500.f, .fpEMax = 500.f, .fpEMin = 0.5f},
...
ST_MOTOR rightup_turn_motor = {.motor_id = 3, .motor_type = M2006,.uiGearRatio = M2006_uiGearRatio, .ControlLoop_State = SPEED_LOOP, .Input = 0.0f, .motor_encoder = {.siNumber = 8192, .siSumValue = 0, .siRawValue = 0, .state = 0}, 
   .pid_inner = {.fpKp = 180.f, .fpKi = 0.005f, .fpKd = 0.002f, .fpUMax = 9000.f, .fpUpMax = 9000.f, .fpUdMax = 5000.f, .fpSumEMax = 5000.f, .fpEMax = 500.f, .fpEMin = 1.0f},
    .pid_outer = {.fpKp = 5.f, .fpKi = 0.02f, .fpKd = 1.5f, .fpUMax = 400.f, .fpUpMax = 400.f, .fpUdMax = 80.f, .fpSumEMax = 500.f, .fpEMax = 500.f, .fpEMin = 0.5f},
    .td = {.r = 10000.f, .h = 0.001f, .T = 0.001f}};
ST_MOTOR rightdown_turn_motor = {.motor_id = 7, .motor_type = M2006,.uiGearRatio = M2006_uiGearRatio, .ControlLoop_State = SPEED_LOOP, .Input = 0.0f, .motor_encoder = {.siNumber = 8192, .siSumValue = 0, .siRawValue = 0, .state = 0}, 
  .pid_inner = {.fpKp = 180.f, .fpKi = 0.005f, .fpKd = 0.002f, .fpUMax = 9000.f, .fpUpMax = 9000.f, .fpUdMax = 5000.f, .fpSumEMax = 5000.f, .fpEMax = 500.f, .fpEMin = 1.0f},
    .pid_outer = {.fpKp = 5.f, .fpKi = 0.02f, .fpKd = 1.5f, .fpUMax = 400.f, .fpUpMax = 400.f, .fpUdMax = 80.f, .fpSumEMax = 500.f, .fpEMax = 500.f, .fpEMin = 0.5f},
    .td = {.r = 10000.f, .h = 0.001f, .T = 0.001f}};
ST_MOTOR leftdown_turn_motor = {.motor_id = 5, .motor_type = M2006,.uiGearRatio = M2006_uiGearRatio, .ControlLoop_State = SPEED_LOOP, .Input = 0.0f, .motor_encoder = {.siNumber = 8192, .siSumValue = 0, .siRawValue = 0, .state = 0}, 
    .pid_inner = {.fpKp = 180.f, .fpKi = 0.005f, .fpKd = 0.002f, .fpUMax = 9000.f, .fpUpMax = 9000.f, .fpUdMax = 5000.f, .fpSumEMax = 5000.f, .fpEMax = 500.f, .fpEMin = 1.0f},
    .pid_outer = {.fpKp = 5.f, .fpKi = 0.02f, .fpKd = 1.5f, .fpUMax = 400.f, .fpUpMax = 400.f, .fpUdMax = 80.f, .fpSumEMax = 500.f, .fpEMax = 500.f, .fpEMin = 0.5f},
    .td = {.r = 10000.f, .h = 0.001f, .T = 0.001f}};
...
ST_Chassis_Run chassis_run = {
    .leftup = {.fpKp = 90.f, .fpKi = 0.3f, .fpKd = 9.f, .fpUMax = 16000.f, .fpUpMax = 16000.f, .fpUdMax = 4000.f, .fpSumEMax = 2000.f, .fpEMax = 300.f, .fpEMin = 0.5f},
    .rightup = {.fpKp = 90.f, .fpKi = 0.3f, .fpKd = 12.f, .fpUMax = 16000.f, .fpUpMax = 16000.f, .fpUdMax = 4000.f, .fpSumEMax = 2000.f, .fpEMax = 300.f, .fpEMin = 0.5f},
    .leftdown = {.fpKp = 85.f, .fpKi = 0.3f, .fpKd = 9.f, .fpUMax = 16000.f, .fpUpMax = 16000.f, .fpUdMax = 4000.f, .fpSumEMax = 2000.f, .fpEMax = 300.f, .fpEMin = 0.5f},
    .rightdown = {.fpKp = 85.f, .fpKi = 0.3f, .fpKd = 9.f, .fpUMax = 16000.f, .fpUpMax = 16000.f, .fpUdMax = 4000.f, .fpSumEMax = 2000.f, .fpEMax = 300.f, .fpEMin = 0.5f},
};
...
ST_PID foot_balance_pid = {.fpKp = 1.f, .fpKi = 0.005, .fpKd = 0.1f, .fpUMax = 5.f, .fpUpMax = 5.f, .fpUdMax = 2.f, .fpSumEMax = 200.f, .fpEMax = 10.f, .fpEMin = 0.1f};
...
uint8_t Rx_from_VET[40]={0}, Tx_to_VET[40]={0};
uint8_t Tx_complete_flag = 0;

long long int tim_ms = 0;
long long int time_cnt = 0, time_cnt_pre = 0;
//状态机
UP_D_STATE up_d_state;
UP_S_STATE up_s_state=-1;
...
//系统自检
ST_SYSTEM_MONITOR my_system_monitor = {0};
