	...
	//down_tx[16] = 0;
		...
		switch (up_s_state) 
		{
			case S_INIT:
				down_tx[6] = 1;
				break;
			case S_GET_BLOCK_DOWN:
				down_tx[7] = 1;
				break;
			case S_GET_BLOCK_UP:
				down_tx[8] = 1;
				break;
			case S_GET_BLOCK_TOP:
				down_tx[9] = 1;
				break;
			case S_THROW_BLOCK_BACK:
				down_tx[10] = 1;
				break;
			case S_THROW_BLOCK_FRONT:
				down_tx[11] = 1;
				break;			
			case S_GIVE_D:
				down_tx[12] = 1;
			...
			case S_GET_D_BLOCK:
				down_tx[13] = 1;
				break;
			case 	S_PUT_BLOCK_MIDDLE:
				down_tx[14] = 1;
				break;
			case 	S_PUT_BLOCK_TOP:
				down_tx[15] = 1;
				break;
